                        ...
                        <table class="table table-bordered table-striped" id="alumniTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=$rowAlumni->alumniTahunLulus?></td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger" id="btn-delete" value="<?=$rowAlumni->alumniID?>">Hapus</button>
                                    </td>
                                </tr>
                                <?php } ?>
...
$(document).ready(function(){
    ...
    $('#alumniTable').on('click','#btn-delete',function(){
        ...
        if (result.isConfirmed) {
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('admin/Alumni/deleteAlumni')?>",
                dataType : "JSON",
                data : {id: id},
